...
import EnfantSlider from "./EnfantSlider";
...
const GstEnfants = () => { 
    return (   
        ...
        <div className="max-w-[1000px] mt-[5]  mx-auto text-center flex flex-col justify-center text-[#0B0C38]">
              ...
              <p className="md:text-3xl text-2xl font-bold text-[#5B112B] my-2">  Vos Enfants : </p>
                <EnfantSlider/>

               
              
                <p className="md:text-2xl text-xl font-bold text-[#5B112B]">  Ajoutez un enfant en appuyant sur ce button : </p>
